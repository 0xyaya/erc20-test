...
contract('MyToken', (accounts) => {
    ...
    it('has a decimal', async () => {
        expect(await MyTokenInstance.decimals()).to.be.bignumber.equal(
            _decimal
        );
    });
    ...
    it('check balance after transfer', async () => {
        ...
        let balanceOwnerBeforeTransfer = await MyTokenInstance.balanceOf(
            _owner
        );
        ...
        await MyTokenInstance.transfer(_recipient, new BN(100), {
            from: _owner,
        });
    ...
    it('check transferFrom owner to recipient with allowance', async () => {
        ...
        await MyTokenInstance.approve(_owner, BN(10));
        await MyTokenInstance.transferFrom(_owner, _recipient, BN(10));
